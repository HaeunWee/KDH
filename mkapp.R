...
mkdata <- function(file, agecut_greater = 4, var.start = "start.dementia", varlist = c('SEX', 'AGE_GROUP', 'MI', 'CHF', 'PVD', 'CD', 'DE', 'CPD', 
                                                                                       ...
                                                                                       'AH', 'Pre_Statin', 'Pre_Metformin', 'Pre_Aspirin', 'Pre_NSAIDs_COX2', 'Pre_Clopidogrel', 'Pre_Steroid', 'Pre_Estrogen', 'Pre_Antithyroid', 'Pre_Thyroxine',  
...
matchfun <- function(filedir = "/home/whe/osteo", filenames = list.files("/home/whe/osteo"), agecut_greater = 4, var.start = "start.dementia", 
                     varlist = c('SEX', 'AGE_GROUP', 'MI', 'CHF', 'PVD', 'CD', 'DE', 'CPD', 'RD', 'PUD', 'MLD', 'DWOCC', 'DWCC', 'HOP', 'AMILALEMNOS', 'MOSLD', 'MST', 
                                 'AH', 'Pre_Statin', 'Pre_Metformin', 'Pre_Aspirin', 'Pre_NSAIDs_COX2', 'Pre_Clopidogrel','Pre_Steroid', 'Pre_Estrogen', 'Pre_Antithyroid', 'Pre_Thyroxine', 'Pre_Depress', 'Pre_Parkinson', 'Pre_Epilepsy', 'EXPCON', 'CCI'),
                     wo = 180, caliper = 0.2){
  ...
  dinfo <- lapply(seq_along(dlist.original), function(i){
    ...
    label[variable == "RD", `:=`(var_label = "Previous Renal disease", val_label = c("No", "Yes"))]
...
for (oc in c("dementia", "vasculardementia", "cerebralinfarction", "osteoporosis", "ovf", "ohf")){
  ...
  ## Run matchfun
  dinfo <- matchfun(filedir = "/home/whe/osteo", filenames = list.files("/home/whe/osteo"), 
  ...
  dir.create(paste0("/home/js/ShinyApps/", oc, "_v3"), showWarnings = F)
  
  ## Copy app.R 
  file.copy("/home/js/ShinyApps/app.R", paste0("/home/js/ShinyApps/", oc, "_v3/", "app.R"), overwrite  = T)
  
  saveRDS(dinfo, paste0("/home/js/ShinyApps/", oc, "_v3/", "dinfo.RDS"))
  saveRDS(list.tb1, paste0("/home/js/ShinyApps/", oc, "_v3/", "tb1.RDS"))
  print(paste0(oc, " end"))
}
